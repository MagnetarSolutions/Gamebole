      ...
      <div className="max-w-[2000px]">
        ...
        <div className="w-full h-[1044px] flex items-center justify-center relative">
          <div className="max-w-[40%]">
            <div className="font-syne text-6xl font-bold text-[#051B39] leading-tight mb-2">
              GAMEBOLE KNOWLEDGE CENTER
            </div>
            <div className=" font-raleway text-[#051B39] text-xl font-normal leading-normal mb-8">
