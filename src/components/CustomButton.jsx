...
const CustomButton = ({
  ...
  if (isSmall)
    return (
      <div className="overflow-hidden w-[160px] h-[50px] group">
        ...
        <div className="absolute w-[160px] h-[50px] rounded-lg bg-[#051B39] dark:bg-[#FF9900] flex justify-center items-center cursor-pointer text-[#FF9900] dark:text-white md:group-hover:ml-1 overflow-hidden md:group-hover:mt-1 transition-all duration-300 ease-in-out box-shadow md:group-hover:shadow-none">
  ...
  return (
    <div className="overflow-hidden w-[140px] md:w-[210px] h-[50px] md:h-[78px] group">
      ...
      <div className="absolute w-[140px] md:w-[210px] h-[50px] md:h-[78px] rounded-lg bg-[#002B65] dark:bg-[#FF9900] flex justify-center items-center cursor-pointer text-[#FF9900] dark:text-white md:group-hover:ml-2 overflow-hidden md:group-hover:mt-2 transition-all duration-300 ease-in-out box-shadow md:group-hover:shadow-none">
