...
const GameCard = ({ game }) => {
  ...
  return (
    <div className="overflow-hidden p-4 w-[450px] mt-10 service-content-gradient-A">
      <h3 className="w-full text-center font-syne font-semibold text-3xl mb-8 transition-color duration-1000 text-white">{game.title}</h3>
      <img src={game.image1} alt={game.title} className="max-w-full h-10 mb-4" />
      <p className="w-full mb-3 text-start font-raleway text-lg leading-tight transition-color duration-1000 text-white">{game.description1}</p>
      <img src={game.image2} alt={game.title} className="max-w-full h-10 mb-4" />
      <p className="w-full mb-3 text-start font-raleway text-lg leading-tight transition-color duration-1000 text-white">{game.description2}</p>
...
const ServiceSDKcard = () => {
  ...
  return (
    ...
    <img src={mainimg} alt="" className="absolute top-10 w-60 left-32"/>
      <h2 className="text-3xl font-bold text-gray-800 dark:text-white">SDK's</h2>
      ...
      <div className="flex items-center justify-center gap-[580px]">
        ...
        >
          ...
          <span className="text-lg font-medium">Functionalites</span>
        </div>
      </div>
